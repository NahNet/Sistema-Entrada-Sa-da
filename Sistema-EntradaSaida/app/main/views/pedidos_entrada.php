...
<div class="conteudo">
  ...
  searchInput.addEventListener('keyup', () => {
    ...
    pedidos.forEach(pedidos => {
      const nome = pedidos.dataset.nome.toLowerCase();
      const status = pedidos.dataset.status.toLowerCase();
      pedidos.style.display = (nome.includes(value) || status.includes(value)) ? 'block' : 'none';
    });
  });
